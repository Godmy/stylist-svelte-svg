...
<Story
	id="atoms-table-header"
	title="Table Header"
	component={TableHeader}
	category="Atoms"
	description="A header component for tables."
	{controls}
>
	{#snippet children(values: any)}
		<section class="_c1">
			<div class="_c2">
				<p class="_c3">Primary Table Header Example</p>
				<p class="_c4">SlotToggle structure and sorting hint visibility.</p>

				<div class="_c5">
					<table class="_c6 divide-[--color-border-primary]">
						<TableHeader>
							{#snippet content()}
								<TableRow>
									{#snippet content()}
										...
										{#if values.showThirdColumn}
											<TableCell variant="header"
												>Column C{values.showSortHint ? ' ' : ''}</TableCell
											>
										{/if}
									{/snippet}
								</TableRow>
			...
			<div class="_c7">
				<h3 class="_c8">Header Variations</h3>
				<p class="_c9">Different header configurations.</p>

				<div class="_c10">
					<article class="_c11">
						<p class="_c12">Compact Header</p>
						<table class="_c6 divide-[--color-border-primary]">
							<TableHeader>
								{#snippet content()}
									<TableRow>
