import type { RecipePlaygroundDrawingOverlay } from '$stylist/playground/interface/recipe/playground-drawing-overlay';
export function createPlaygroundDrawingOverlayState(props: RecipePlaygroundDrawingOverlay) {
